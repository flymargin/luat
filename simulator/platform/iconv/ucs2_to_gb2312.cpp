...
const UINT8 number_of_bit_1[256] = 
{
...
/* 0x4E00 <= ucs2 < 0xA000 */ 
static UINT16 get_ucs2_offset(UINT16 ucs2)
{
    ...
    mirror_ptr = (UINT8*)&ucs2_mirror_4E00_9FFF[page][tmp<<3]; /* [0, 8, 16, 24] */ 
...
size_t iconv_ucs2_to_gb2312_endian(char **_inbuf, size_t *inbytesleft, char **_outbuf, size_t *outbytesleft, int endian)
{
    ...
    while(inlen > 0)
    {
        ...
        else
        {
            ...
            {
                UINT16 u16count = sizeof(tab_UCS2_to_GBK)/4;
                UINT16 ui = 0;
